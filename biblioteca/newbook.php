   ...
   <header> <!-- Inicio do Header -->
    ...
    <!-- CARD 1 -->
      <div class="col-sm-12 col-lg-12 mb-2">
        <div class="card">
          ...
          <div class="card-header bg-primary content-center text-white">Cadastrar Livro
          </div>

          <div class="card-body row">
            <div class="col">
              
              <form method="POST" action="valida_livros.php">
                ...
                <div class="form-row">
                  ...
                  <div class="form-group col-md-2">
                    <label class="form-text" for="qtd-livro">Quantidade de Livros</label>
                    <input id="qtd-livro" class="form-control" type="number" name="qtd-livro" placeholder="Ex: 429">
                  </div>

                  <div class="form-group col-md-2">
                    <label class="form-text" for="paginas-livro">Número de Páginas&nbsp;</label>
                    <input id="paginas-livro" class="form-control" type="number" name="paginas-livro" placeholder="Ex: 648">
                  </div>
                  ...
                  <div class="form-group col-md-2">
                   ...
                   <div class="form-group col-md-6">
                    ...
                    <input id="data"  class="form-control" type="text" name="data-cad" disabled="true">
                  </div>
    ...
    <?php if( isset($_GET['inclusao']) && $_GET['inclusao'] == 1) { ?>
      <script type="text/javascript">
        document.getElementById('modalTitle').innerHTML = 'Uhuuul, livro cadastrado!'
        document.getElementById('modalContent').innerHTML = 'Um novo livro foi cadastrado na biblioteca, e agora está disponivel para atribuição!'
